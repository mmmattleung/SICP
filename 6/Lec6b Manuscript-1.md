...
# a = nth_stream(100, filter_stream(no_seven, integers()))
# print(a)
...
# aaa(filter_stream(no_seven, integers()))

# print_stream(filter_stream(no_seven, integers()))
``````
